...
var map = new ol.Map({
    ...
    layers: layersList,
    view: new ol.View({
        extent: [6849019.659235, 3619522.490737, 6863434.313463, 3630188.233987], maxZoom: 28, minZoom: 1
    })
});
...
map.getView().fit([6849019.659235, 3619522.490737, 6863434.313463, 3630188.233987], map.getSize());
